...
<%
	// 可將參數傳到 defaulTo 或 to ; 看情況調用本 sendmail
		...
		String emailBody = "<table id='sort' class='sort'><thead><tr><th></th>"
			+ "<th scope='col' abbr='Starter' class='text-danger'><h4>訂票成功</h4></th>" + "</tr></thead>"
			+ "<tfoot><tr><th scope='row'>訂票總金額:</th><td class='text-success'><h4>" + s1[6] + "</h4></td>"
			+ "</tr></tfoot>"
			+ "</table>"
